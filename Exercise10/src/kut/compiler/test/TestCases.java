...
class TestCases {
	...
	@Test
	void parser1000() throws Exception {
		String testname = Thread.currentThread().getStackTrace()[1].getMethodName();
		testParser(testname, "testcode1000");
	}
	
	@Test
	void parser1001() throws Exception {
		String testname = Thread.currentThread().getStackTrace()[1].getMethodName();
		testParser(testname, "testcode1001");
	}

	
	@Test
	void cgen1000() throws Exception {
		String testname = Thread.currentThread().getStackTrace()[1].getMethodName();
		testCompiler(testname, "testcode1000");
	}

	@Test
	void cgen1001() throws Exception {
		String testname = Thread.currentThread().getStackTrace()[1].getMethodName();
		testCompiler(testname, "testcode1001");
	}
