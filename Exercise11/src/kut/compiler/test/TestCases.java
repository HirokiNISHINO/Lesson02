...
class TestCases {
	...
	@Test
	void parser1100() throws Exception {
		String testname = Thread.currentThread().getStackTrace()[1].getMethodName();
		testParser(testname, "testcode1100");
	}
	
	@Test
	void parser1101() throws Exception {
		String testname = Thread.currentThread().getStackTrace()[1].getMethodName();
		testParser(testname, "testcode1101");
	}

	
	@Test
	void cgen1100() throws Exception {
		String testname = Thread.currentThread().getStackTrace()[1].getMethodName();
		testCompiler(testname, "testcode1100");
	}

	@Test
	void cgen1101() throws Exception {
		String testname = Thread.currentThread().getStackTrace()[1].getMethodName();
		testCompiler(testname, "testcode1101");
	}
