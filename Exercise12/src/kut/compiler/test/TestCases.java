...
class TestCases {
	...
	@Test
	void parser1200() throws Exception {
		String testname = Thread.currentThread().getStackTrace()[1].getMethodName();
		testParser(testname, "testcode1200");
	}
	
	@Test
	void parser1201() throws Exception {
		String testname = Thread.currentThread().getStackTrace()[1].getMethodName();
		testParser(testname, "testcode1201");
	}


	@Test
	void parser1202() throws Exception {
		String testname = Thread.currentThread().getStackTrace()[1].getMethodName();
		testParser(testname, "testcode1202");
	}

	@Test
	void parser1203() throws Exception {
		String testname = Thread.currentThread().getStackTrace()[1].getMethodName();
		testParser(testname, "testcode1203");
	}

	@Test
	void cgen1200() throws Exception {
		String testname = Thread.currentThread().getStackTrace()[1].getMethodName();
		testCompiler(testname, "testcode1200");
	}

	@Test
	void cgen1201() throws Exception {
		String testname = Thread.currentThread().getStackTrace()[1].getMethodName();
		testCompiler(testname, "testcode1201");
	}
		
	@Test
	void cgen1202() throws Exception {
		String testname = Thread.currentThread().getStackTrace()[1].getMethodName();
		testCompiler(testname, "testcode1202");
	}

	@Test
	void cgen1203() throws Exception {
		String testname = Thread.currentThread().getStackTrace()[1].getMethodName();
		testCompiler(testname, "testcode1203");
	}
