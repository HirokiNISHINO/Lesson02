...
class TestCases {
	...
	@Test
	void parser900() throws Exception {
		String testname = Thread.currentThread().getStackTrace()[1].getMethodName();
		testParser(testname, "testcode900");
	}
	
	@Test
	void parser901() throws Exception {
		String testname = Thread.currentThread().getStackTrace()[1].getMethodName();
		testParser(testname, "testcode901");
	}


	
	@Test
	void cgen900() throws Exception {
		String testname = Thread.currentThread().getStackTrace()[1].getMethodName();
		testCompiler(testname, "testcode900");
	}

	
	@Test
	void cgen901() throws Exception {
		String testname = Thread.currentThread().getStackTrace()[1].getMethodName();
		testCompiler(testname, "testcode901");
	}
